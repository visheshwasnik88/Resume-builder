...
import {setDocumnet,setSkin,updateDocumnet,updateSkin} from '../../redux/actions/documentActions'
...
function GettingStarted(props) {
  ...
  const mapDispatchToProps=(dispatch)=>{
    return{
        ...
        updateDocumnet:(skinCd)=>dispatch(updateSkin(skinCd))
    }
  }
